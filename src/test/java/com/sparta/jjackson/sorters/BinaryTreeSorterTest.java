...
class BinaryTreeSorterTest {
    ...
    private final Sorter binTree = new BinaryTreeSorter();
    ...
    void testSmallBubble() {
        Assertions.assertArrayEquals(arr20Sorted, binTree.sortArray(arr20));
    }

    @Test
    @DisplayName("Test bubble sort works / 100 item array")
    void testMediumBubble() {
        Assertions.assertArrayEquals(arr100Sorted, binTree.sortArray(arr100));
    }

    @Test
    @DisplayName("Test bubble sort works / 1000 item array")
    void testLargeBubble() {
        Assertions.assertArrayEquals(arr1000Sorted, binTree.sortArray(arr1000));
    }
}